...
app.get('/p/:postId', getPost);
app.delete('/p/:postId', FBAuth, deletePost);
app.get('/p/:postId/like', FBAuth, likePost);
app.get('/p/:postId/unlike', FBAuth, unlikePost);
app.post('/p/:postId/comment', FBAuth, commentOnPost);
...
// exports.createNotificationOnLike = functions.firestore.document('posts/{postId}') 
//     .onUpdate((snapshot) => {
